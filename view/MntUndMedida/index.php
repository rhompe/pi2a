<?php
    ...
    $rol = new Rol();
    $datos = $rol->validar_acceso_rol($_SESSION["USU_ID"],"mntundmedida");
...
<head>
    <title>AnderCode | Unidad de Medida</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Mantenimiento Unidad de Medida</h4>
    ...
    <script type="text/javascript" src="mntundmedida.js"></script>
</body>
